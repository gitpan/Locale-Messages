package Locale::Messages::Sets::lm_gui::fr_FR;
####################################################
...
',
   ...
   'create_set: window title' => {
      'vers'  => 1,
      'text'  => '[COM] :: Créer une série de messages de Locale::Messages
',
   },
   'error' => {
      'vers'  => 1,
...
',
   ...
   'manage_set: window title' => {
      'vers'  => 1,
      'text'  => '[COM] :: Gérer une série de messages de Locale::Messages
',
   },
...
',
   ...
   'select_operation: window title' => {
      'vers'  => 1,
      'text'  => '[COM] :: série de messages de Locale::Messages
',
   },
);
...
Locale::Messages::Sets::lm_gui::fr_FR -- Localized messages
